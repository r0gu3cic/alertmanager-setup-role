# ALERTMANAGER-SETUP-ROLE

=========

This Ansible role installs and configures the Alertmanager service on an Ubuntu server. It prepares the system for production use, enabling alert processing and routing.
...
- **`alertmanager.version`**: The version of Alertmanager we want installed.
